...
const SMKNWebsite = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white" style={{ scrollBehavior: 'smooth' }}>
      {/* Header/Navbar */}
      <nav className="bg-gradient-to-r from-purple-600 to-blue-500 px-6 py-3 shadow-lg fixed w-full top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-6 text-sm">
            <button onClick={() => scrollToSection('home')} className="hover:text-purple-200 transition bg-transparent border-0 cursor-pointer">HOME</button>
            <button onClick={() => scrollToSection('visi-misi')} className="hover:text-purple-200 transition bg-transparent border-0 cursor-pointer">VISI & MISI</button>
            <button onClick={() => scrollToSection('berita')} className="hover:text-purple-200 transition bg-transparent border-0 cursor-pointer">BERITA</button>
            <button onClick={() => scrollToSection('fasilitas')} className="hover:text-purple-200 transition bg-transparent border-0 cursor-pointer">FASILITAS</button>
            <button onClick={() => scrollToSection('contact')} className="hover:text-purple-200 transition bg-transparent border-0 cursor-pointer">CONTACT</button>
          </div>
        </div>
      </nav>
      ...
      {/* Hero Section - Mudah dimodifikasi */}
      <section id="home">
        <div 
        ...
        <div className="text-center z-10 px-4">
          {/* EDIT TEXT DI BAWAH INI: */}
          <p className="text-sm mb-2 text-purple-200 uppercase tracking-wide">Selamat Datang di</p>
          <h1 className="text-6xl font-bold mb-4 drop-shadow-lg">SMKN 1 Majalengka</h1>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button className="bg-gradient-to-r from-purple-600 to-purple-700 px-8 py-4 rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105">
              Mulai Sekarang
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-purple-600 transition-all font-semibold text-lg shadow-lg backdrop-blur-sm">
        ...
        <section id="visi-misi" className="max-w-7xl mx-auto px-6 py-16">
